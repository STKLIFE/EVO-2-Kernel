...
//  modify by yfx
	hb = imgsensor.dummy_pixel + GC2235SUB_DEFAULT_DUMMY_PIXEL_NUMS;
	vb = imgsensor.dummy_line + GC2235SUB_DEFAULT_DUMMY_LINE_NUMS;
...
/////////////////////////////////////////////////////
...
#else
	write_cmos_sensor(0xf7, 0x15); //pll enable
	write_cmos_sensor(0xf8, 0x86); //Pll mode 2//86
	...
	//////////////////////	 BLK   //////////////////////
	/////////////////////////////////////////////////////
	write_cmos_sensor(0x40, 0x70); //BLK
	...
	write_cmos_sensor(0x4a, 0x20);
	write_cmos_sensor(0x4b, 0x20);	

	write_cmos_sensor(0x40, 0x73); //smooth speed 
	write_cmos_sensor(0x41, 0x04);
	write_cmos_sensor(0x43, 0x18); //global_offset 20140124 lanking
	write_cmos_sensor(0x5e, 0x18);
	write_cmos_sensor(0x5f, 0x18);
	write_cmos_sensor(0x60, 0x18);
	write_cmos_sensor(0x61, 0x18); 
	write_cmos_sensor(0x62, 0x18);
	write_cmos_sensor(0x63, 0x18); 
	write_cmos_sensor(0x64, 0x18);
