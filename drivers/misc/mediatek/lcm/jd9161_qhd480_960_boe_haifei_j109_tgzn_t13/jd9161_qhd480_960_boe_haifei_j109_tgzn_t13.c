...
#if defined(BUILD_LK)
	printf("jd9161_qhd480_960_boe_haifei_j109_tgzn_t13  id1 = 0x%08x\n", id);
#else
	printk("jd9161_qhd480_960_boe_haifei_j109_tgzn_t13 id1 = 0x%08x\n", id);
#endif
...
#ifdef BUILD_LK
	printf("uboot jd9161_qhd480_960_boe_haifei_j109_tgzn_t13 %s\n", __func__);
#else
	printk("kernel jd9161_qhd480_960_boe_haifei_j109_tgzn_t13 %s\n", __func__);
#endif
}
...
#ifdef BUILD_LK
	printf("jd9161_qhd480_960_boe_haifei_j109_tgzn_t13 uboot %s\n", __func__);
#else
	printk("jd9161_qhd480_960_boe_haifei_j109_tgzn_t13 kernel %s\n", __func__);	
#endif
...
LCM_DRIVER  jd9161_qhd480_960_boe_haifei_j109_tgzn_t13_lcm_drv = 
{
    .name			= "jd9161_qhd480_960_boe_haifei_j109_tgzn_t13",
