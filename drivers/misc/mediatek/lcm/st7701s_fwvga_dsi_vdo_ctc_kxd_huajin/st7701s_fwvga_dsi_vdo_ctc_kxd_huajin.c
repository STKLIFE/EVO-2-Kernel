...
static unsigned int lcm_compare_id(void)
{
	...
	#ifdef BUILD_LK
	printf("%s, LK st7701s_wvga_dsi_vdo_ctc_kxd_guangtai id = 0x%x%x%x\n", __func__, buffer[0],buffer[1],buffer[2]);//buffer[0]=0x83  buffer[1]=0x92  buffer[2]=0x0B
	#else
	printk("kevin: st7701s_wvga_dsi_vdo_ctc_kxd_guangtai id 0x04= 0x%x%x%x\n",buffer[0],buffer[1],buffer[2]);
	#endif
...
LCM_DRIVER  st7701s_fwvga_dsi_vdo_ctc_kxd_huajin_lcm_drv = 
{
    .name			= "st7701s_fwvga_dsi_vdo_ctc_kxd_huajin",
