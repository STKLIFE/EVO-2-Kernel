...
static void lcm_init(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_dsi_vdo_boe_guangtai_liangyong_r52 %s\n", __func__);
    #else
    printk("st7701s_qhd480_960_dsi_vdo_boe_guangtai_liangyong_r52 %s\n", __func__);
    #endif
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_dsi_vdo_boe_guangtai_liangyong_r52 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_qhd480_960_dsi_vdo_boe_guangtai_liangyong_r52 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
...
LCM_DRIVER st7701s_qhd480_960_dsi_vdo_boe_ips_guangtai_liangyong_r52_lcm_drv =
{
    .name			= "st7701s_qhd480_960_dsi_vdo_boe_ips_guangtai_liangyong_r52",
