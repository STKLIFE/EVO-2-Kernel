...
static void lcm_init(void)
{
	...
	#ifdef BUILD_LK
    printf("st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m lcm_init\n");
	#else
	printk("st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m lcm_init\n");
	#endif
}
...
{
#ifdef BUILD_LK
	printf("uboot st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m %s\n", __func__);
#else
	printk("kernel st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m %s\n", __func__);
#endif
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
...
LCM_DRIVER  st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m_lcm_drv = 
{
    .name			= "st7701s_fwvga_dsi_vdo_boe_j106_kuangre_a19m",
