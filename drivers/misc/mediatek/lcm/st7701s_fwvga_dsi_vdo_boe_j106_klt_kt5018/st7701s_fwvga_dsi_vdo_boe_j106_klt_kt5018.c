...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 lk id_adc=%d\n", id_adc);
    printf("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
	
	if(id_adc==2&&0x8802 == id)
	{
	 #ifdef BUILD_LK
    printf("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 return 1;");
    #else
    printk("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 return 1;");
    #endif
		return 1;
	}
		 #ifdef BUILD_LK
    printf("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 return 0;");
    #else
    printk("st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018 return 0;");
    #endif
	return 0;
...
LCM_DRIVER st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018_lcm_drv =
{
    .name			= "st7701s_fwvga_dsi_vdo_boe_j106_klt_kt5018",
