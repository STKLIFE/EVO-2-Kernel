...
{0xE5,16,{0x0C,0xD0,0x3C,0x8C,0x0E,0xD2,0x3C,0x8C,0x10,0xD4,0x3C,0x8C,0x12,0xD6,0x3C,0x8C}},

{0xE6,4 ,{0x00,0x00,0x33,0x33}},

{0xE7,2 ,{0x44,0x44}},

{0xE8,16,{0x0D,0xD1,0x3C,0x8C,0x0F,0xD3,0x3C,0x8C,0x11,0xD5,0x3C,0x8C,0x13,0xD7,0x3C,0x8C}},
...
static void lcm_init(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_ivo_tgzn_j109_t13 %s\n", __func__);
    #else
    printk("st7701s_qhd480_960_ivo_tgzn_j109_t13 %s\n", __func__);
    #endif
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_ivo_tgzn_j109_t13 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_qhd480_960_ivo_tgzn_j109_t13 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
    #ifdef BUILD_LK
...
LCM_DRIVER st7701s_qhd480_960_ivo_tgzn_j109_t13_lcm_drv =
{
    .name			= "st7701s_qhd480_960_ivo_tgzn_j109_t13",
