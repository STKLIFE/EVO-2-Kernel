...
static void lcm_init(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_ips_boe_qicai_bp_b009 %s\n", __func__);
    #else
    printk("st7701s_qhd480_960_ips_boe_qicai_bp_b009 %s\n", __func__);
    #endif
...
static int adc_read_vol(void)
{
    ...
    adc_vol = sum/10;
#if defined(BUILD_LK)
    printf("st7701s_qhd480_960_ips_boe_qicai_bp_b009 test adc_vol is %d\n",adc_vol);
#else
    printk("st7701s_qhd480_960_ips_boe_qicai_bp_b009 test adc_vol is %d\n",adc_vol);
#endif
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_ips_boe_qicai_bp_b009 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_qhd480_960_ips_boe_qicai_bp_b009 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
	
	if(0x8802 == id && 1==id_adc)
	{
		return 1;
	}
...
LCM_DRIVER st7701s_qhd480_960_ips_boe_qicai_bp_b009_lcm_drv =
{
    .name			= "st7701s_qhd480_960_ips_boe_qicai_bp_b009",
