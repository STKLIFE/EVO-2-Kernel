...
static void lcm_init(void)
{
	...
	#ifdef BUILD_LK
    printf("st7701s_wvga_dsi_vdo_boe_ruiyang_g3407 lcm_init\n");
	#else
	printk("st7701s_wvga_dsi_vdo_boe_ruiyang_g3407 lcm_init\n");
	#endif
}
...
{
#ifdef BUILD_LK
	printf("uboot st7701s_wvga_dsi_vdo_boe_ruiyang_g3407 %s\n", __func__);
#else
	printk("kernel st7701s_wvga_dsi_vdo_boe_ruiyang_g3407 %s\n", __func__);
#endif
	lcm_init();
}
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_wvga_dsi_vdo_boe_ruiyang_g3407 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_wvga_dsi_vdo_boe_ruiyang_g3407 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
...
LCM_DRIVER st7701s_wvga_dsi_vdo_boe_ruiyang_g3407_lcm_drv =
{
    .name			= "st7701s_wvga_dsi_vdo_boe_ruiyang_g3407",
