...
static void lcm_init(void)
{
	...
	#ifdef BUILD_LK
    printf("st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 lcm_init\n");
	#else
	printk("st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 lcm_init\n");
	#endif
}
...
{
#ifdef BUILD_LK
	printf("uboot st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 %s\n", __func__);
#else
	printk("kernel st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 %s\n", __func__);
#endif
	lcm_init();
}
...
static int adc_read_vol(void)
{
    ...
    adc_vol = sum/10;
#if defined(BUILD_LK)
    printf("st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 test adc_vol is %d\n",adc_vol);
#else
    printk("st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 test adc_vol is %d\n",adc_vol);
#endif
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
    printf("st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #else
    printk("st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52 %s,buffer[0]=0x%x,buffer[1]=0x%x,id = 0x%x\n", __func__,buffer[0],buffer[1],id);
    #endif
...
LCM_DRIVER st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52_lcm_drv =
{
    .name			= "st7701s_qhd480_960_dsi_vdo_ivo_guangtai_lianyong_r52",
