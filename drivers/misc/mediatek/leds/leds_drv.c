...
#if defined (CONFIG_LCM_BACKLIGHT_RESUME_DELAY)
extern int is_mtkfb_late_resume;
#endif
			   ...
			   enum led_brightness level)
{
    ...
    #if defined (CONFIG_LCM_BACKLIGHT_RESUME_DELAY)
    printk("mt65xx_led_set aaa is_mtkfb_late_resume=%d\n",is_mtkfb_late_resume);
    if(is_mtkfb_late_resume == 1)
    {
        msleep(200);
        is_mtkfb_late_resume = 0;
        printk("mt65xx_led_set bbb is_mtkfb_late_resume=%d\n",is_mtkfb_late_resume);
    }
    #endif
